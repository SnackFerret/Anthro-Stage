...
Anthro Stage is opensource however we reserve the right to offer paid none core/critical none open source 3D printable files as DLC to help fund the projects on going development. These are only forsale through Sketchfab if you see them available elsewhere they've been stolen or re-distributed without our permission.
